        ...
        protected void AddExpense(object sender, EventArgs e)
        {
            ...
            try
            {
                using (con)
                {
                    ...
                    //String q = string.Format("insert into expenses values('{0}','{1}','{2}','{3}','{4}','{5}','{6}')", Session["userID"], en, ed, amount, givenDate, todayDate);
                    String q = string.Format("insert into expenses values('{0}','{1}','{2}','{3}','{4}','{5}')", en,ed,amount,givenDate, Session["userID"],todayDate);
